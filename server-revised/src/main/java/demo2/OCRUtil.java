...
public class OCRUtil {
    ...
    private String transname = "haha";// 默认中文语言包，识别中文 chi_sim

    private String transPath = "tessdata"; // 语言包的位置
...
//        pb.directory(new File("C:\\Program Files (x86)\\Tesseract-OCR"));
