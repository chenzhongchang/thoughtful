package csj.thoughtful.vipconcurrent.project.two.service;

import csj.thoughtful.vipconcurrent.project.two.assist.SL_Busi;
import csj.thoughtful.vipconcurrent.project.two.service.question.ParallerQstService;
import csj.thoughtful.vipconcurrent.project.two.service.question.SingleQstService;
import csj.thoughtful.vipconcurrent.project.two.vo.SrcDocVo;
import csj.thoughtful.vipconcurrent.project.two.vo.TaskResultVo;
import java.util.HashMap;
import java.util.Map;
import java.util.Random;
import java.util.concurrent.ExecutionException;

//处理文档的服务，包括文档中题目的处理和文档生成后的上传
public class ProduceDocService {
    //上传文档到网络
    // docFileName 实际文档在本地的存储位置
    // return 上传后的网络存储地址
