...
import custom.pool.vo.ITaskProcesser;
import custom.pool.vo.JobInfo;
import custom.pool.vo.TaskResult;
import custom.pool.vo.TaskResultType;
...
public class PendingJobPool {
    ...
    //对工作的任务进行包装，提交给线程池使用，并处理的结果，写入缓存供查询
    private static ExecutorService taskExcecutor=
    ...
    //对工作中的任务进行包装，提交线程池使用，并处理任务的结果，写入缓存以供查询
