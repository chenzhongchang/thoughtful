...
class MainFrame extends JFrame implements ActionListener, ItemListener {
	...
	private String pics=new String("E:\\thoughtful-java\\thoughtful\\mygames\\target\\classes\\mygames\\pushbox\\");
	MainFrame() {
		super("推箱子");
	...
	private void init() {
		...
		/************** 添加最小化图标   **************/
		super.setIconImage(new ImageIcon(pics+"pic\\3.gif").getImage());
