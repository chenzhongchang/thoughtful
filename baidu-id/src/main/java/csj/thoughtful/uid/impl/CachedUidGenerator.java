 ...
 */
package csj.thoughtful.uid.impl;

import java.util.ArrayList;
import java.util.List;

import csj.thoughtful.uid.BitsAllocator;
import csj.thoughtful.uid.buffer.BufferPaddingExecutor;
import csj.thoughtful.uid.buffer.RejectedPutBufferHandler;
import csj.thoughtful.uid.buffer.RejectedTakeBufferHandler;
import csj.thoughtful.uid.buffer.RingBuffer;
import csj.thoughtful.uid.exception.UidGenerateException;
...
/**
 * Represents a cached implementation of {@link DisposableBean} extends
